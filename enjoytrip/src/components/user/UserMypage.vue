<template>
  <div>
    <div class="p-3 py-2 box shadow">
      <b-img v-if="userProfileImg" :src="userProfileImg" fluid rounded="circle" width="200" height="200"></b-img>
    ...
    <div class="px-3 py-2 box">
      ...
      <b-button @click="onClickLogout" variant="outline-secondary" class="col-12 my-1">로그아웃</b-button>
    </div>
  </div>
</template>
...
export default {
  ...
  created() {
    ...
    http({
      ...
      // 프로필 이미지 가져오기
      if (this.userFileInfo.saveFolder != null && this.userFileInfo.originalFile && this.userFileInfo.saveFile) {
        http({
          method: "get",
